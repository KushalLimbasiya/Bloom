  ...
  return (
    <SafeAreaView className="flex-1 w-full items-start justify-start bg-[#EBEAEF] space-y-4">
      <GestureHandlerRootView>
        {/* top section */}
        <View className="flex-row items-center justify-between w-full px-4 py-2 pt-12">
          ...
          <View className="px-3 py-2 rounded-xl bg-white flex items-center justify-center relative">
            <FontAwesome5 name="shopping-bag" size={26} color="black" />
            <View className="absolute px-0.5 bg-[#130d2d] top-0 right-0 rounded-md flex items-center justify-center">
          ...
          <ScrollView className="w-full flex-1">
            ...
            <View className="w-full p-8">
              <View className="w-full px-2 py-2 h-16 rounded-xl bg-white flex-row itece justify-center">
                ...
                />
                <TouchableOpacity className="px-3 py-2 rounded-xl bg-[#130d2d]">
            ...
            <View className="w-full px-8 my-4">
              <TouchableOpacity className="w-full p-2 py-3 rounded-xl bg-[#130d2d] flex items-center justify-center">
