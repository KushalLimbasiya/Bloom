      ...
      {isLoading ? (
        ...
        <>
          <SafeAreaView className="w-full">
            <View className="flex-row items-center justify-between px-4 py-2 w-full mt-10">
          ...
          <View className="w-full flex-1 h-full bg-white rounded-t-[36px] py-8 px-6 space-y-4">
